...
// ARREGLO PARA LEER JSONS
import com.google.gson.JsonArray;
import com.google.gson.JsonObject;
import com.google.gson.JsonParser;

// LIBRERIA PARA ASIGNAR COLORES
// Color puede recibir un RGB y un HEX
import java.awt.Color;
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;
/* LIBRERIA PARA MANEJAR FUENTES
    Para crear un font necesitamos:
    1-Font-Family, tipo Verdana
    2-Tipo de Fuente, usamos Font. para ver los estilos
    3-Tamaño, un numero entero.
*/
...
public class Ventana extends JFrame implements ActionListener {
    ...
    // COMPONONTENTES DE LA VENTANA
        lbl1 = new JLabel("Label de Prueba");
        lbl1.setBounds(20, 10, 125, 30);
        // CREADO MI OBJETO FUENTE
        Font fuente = new Font("Verdana", Font.BOLD, 14);
        // AGREGANDO LA FUENTE
        lbl1.setFont(fuente);
        // AGREGAR COLOR
        lbl1.setForeground(Color.decode("#17A589"));
        ...
        if(ae.getSource() == boton1){
            ...
            for (int i = 0; i < arreglo.size(); i++) {
                ...
                */
                ...
                String codigo = objeto.get("codigo").getAsString();
                ...
                Persona nuevo = new Persona(codigo, nombre, edad, tamaño);
                ...
                Clase10.AgregarPersona(nuevo);
            }
            Clase10.LeerPersonas();
        }
